...
@section('content')
    <main role="main" class="ml-sm-auto col-lg-12 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" id="titulo" >
            <table width="100%">
                <tr>
                    <td><h1 class="h2">Confirma de {{ $persona->nombre }} {{ $persona->apellido }}</h1></td>
                    <td>
                        <button class="btn btn-primary btn-xs btnDescargar" type="button" id="down-" onclick="window.location = '{{url('pdf_confirma', $persona->id)}}'">
                                <i class="fas fa-download" ></i>
                        </button>
                        <button class="btn btn-info btn-xs btnEditar" type="button" id="edit-" onclick="window.location = '{{ url('editar_confirma', $idPersona) }}'" >
        ...
        <div style="padding-top: 2%; padding-left: 15%; padding-bottom: 5%;">
            <table width="70%" cellpadding="10">
                <tr>
                    ...
                    <td>{{ $confirma->fecha }}</td>
                </tr>
                <tr>
                    <td><strong>Padre:</strong></td>
                    <td>{{ $confirma->padre->nombre }} {{ $confirma->padre->apellido }}</td>
                </tr>
                <tr>
                    <td><strong>Ubicación:</strong></td>
                    <td>Libro {{ $confirma->libro }}   Acta {{ $confirma->acta }}   Pagina {{ $confirma->pagina }}</td>
                </tr>
            </table>
        </div>
        ...
        <div style="padding-top: 3%;">
            <table style="text-align: center;" id="padTable" class="table table-striped table-bordered table-sm">
                <thead>
                    <th>Nombre</th>
                    <th>Apellido</th>
                    <th>Sexo</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger">
                        <span class="glyphicon glyphicon-warning-sign"></span> <strong id="msjModal">¿Confirma que desea eliminar esta confirma?</strong>
