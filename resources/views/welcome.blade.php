    ...
    <body>
        <header>
            <nav class="navbar fixed-top menu">
                <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="">PARROQUIA LA TRANSFIGURACIÓN</a>
                @if (Route::has('login'))
                <ul class="navbar-nav px-3">
                    @auth
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ url('/datatable') }}">Datatable <span class="sr-only">(current)</span></a>
                        </li>
                        @else
                            <li class="nav-item active">
